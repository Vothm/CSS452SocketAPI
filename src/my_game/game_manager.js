...
class GameManager {
  ...
  createCross(x, y) {
    let cross = new Cross(
      this.crossSprite,
      this.boxLocationsX[x],
      this.boxLocationsY[y]
    );
  ...
  analyzeGame() {
    //p1
    if (
      this.gameState[0][0] == 1 &&
      this.gameState[0][1] == 1 &&
      this.gameState[0][2] == 1
    ) {
      this.gameEnd = 1;
      return 1;
    }
    if (
      this.gameState[1][0] == 1 &&
      this.gameState[1][1] == 1 &&
    ...
    if (
      this.gameState[1][0] == 2 &&
      this.gameState[1][1] == 2 &&
      this.gameState[1][2] == 2
    ) {
      this.gameEnd = 2;
      return 2;
    }
